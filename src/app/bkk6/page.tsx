...
export default function Bkk6() {
  return (
    <div>
      {/* Itinerary Start */}
      <div className={styles.pageContainer}>
        <div className={styles.imgContainer}>
          <img src="img/internasional/bkk6.png" alt="bkk6" />
        </div>
        <div className={styles.textContainer}>
          ...
          <div className={styles.intenaryContainer}>
            ...
            <div className={styles.flexContainer}>
              <p>
                <span>Dream World Happy Land Bangkok</span>
              </p>
              <p>
                <span>MBK Shopping Mall</span>
              </p>
              <p>
          ...
          <a href="pdf/bkk6.pdf" target="_blank" download>
